class UsersController < ApplicationController
  ...
  def create
    ...
    if user.save
      user.mark_as_confirmed! #TODO Neha: I'm confirming user here, however, we can do using sent email that method also I have mentioned in below code block
